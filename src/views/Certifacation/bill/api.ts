...
const billOpenApi = {
  ...
  /**验证销售单号  */
  checkSaleOrder: (params: IParams) => request.post(`/V1/ApprovalInvoice/view_search`, params),
  ...
  /**上传图片 */
  upload_img: (params: IParams) => request.uploadPost(`/V1/ApprovalInvoice/uploading`, params),
