...
import { paymentApi } from '@/http/api/financecustom/payment'
...
import ModifyAnyway from './components/ModifyAnyway.vue'
  ...
  setup() {
    ...
    const state: IState = reactive({
      ...
      customArgs: {
        ...
        table: CUSTOM_TABLES.PAYMENT_MANAGEMENT
      },
          ...
          paymentApi
            ...
            .then(res => {
              ...
              if (status === 200) {
                ...
                state.commonLists.supplierList2 = state.commonLists.supplierList2.concat(
                  custom_data
                )
                resolve(custom_data)
              }
      ...
      getList() {
        const data = dataStructure(
          {},
          {
            ...
            supplier: state.pagination.supplier,
