 ...
 * @LastEditors: TJ
 * @LastEditTime: 2022-06-15 16:18:00
-->
<template>
  <div class="login">
    <div class="bg_cont">
      <div class="login_box">
        ...
        <div class="back">
          <el-button @click="backLogin" size="small" type="text" class="el-icon-back">
        ...
        <div class="box_logo">
          <img
            ...
            alt="#"
          />
          <img class="img2" v-else src="@/assets/img/login/login-02.png" alt="" />
        </div>
        <div class="box_state">
          <div class="step" v-show="showStep">
            <div class="box_wel">{{ $t('common.stepOne') }}</div>
            <div class="box_info">
              <el-form :model="stepOneForm" ref="stepOneRef" :rules="stepOneRule">
                <el-form-item :label="$t('common.username')" prop="username">
                  <el-input v-model="stepOneForm.username" :placeholder="$t('common.p_username')">
                  </el-input>
                </el-form-item>
                <el-form-item :label="$t('common.email')" prop="email">
                  <el-input v-model="stepOneForm.email" :placeholder="$t('common.p_email')">
                  </el-input>
                </el-form-item>
                <el-form-item :label="$t('common.code')" prop="code">
                  <el-input v-model="stepOneForm.code" :placeholder="$t('common.p_code')">
                    <template #suffix>
                      <el-button @click="getCode" type="text" v-show="!stepOneForm.countDown">{{
                        $t('common.get_code')
                      }}</el-button>
          ...
          <div class="step" v-show="!showStep">
            ...
            <div class="box_info">
              <el-form :model="stepTwoForm" ref="stepTwoRef" :rules="stepTwoRule">
                ...
                <el-form-item :label="$t('common.rePassword')" prop="rePassword">
                  <el-input
                    type="password"
...
import { checkPassword, reCheckPassword, checkUsername, checkEmail } from '@/utils/regp'
export default defineComponent({
  setup() {
    ...
    const stepOneRule = computed(() => {
      const rule = {
        username: [{ required: true, message: t('common.not_empty'), trigger: 'change' }],
        email: [{ required: true, validator: checkEmail, trigger: 'change' }],
        code: [{ required: true, message: t('common.not_empty'), trigger: 'change' }]
      }
      return rule
    })
