...
export const deliveryinventoryApi = {
  ...
  get_index: (params: IParams) => request.post(`/V1/InventoryDelivery/index`, params),
  // 出库信息列表接口：V1/InventoryDelivery/list
  get_list: (params: IParams) => request.post(`/V1/InventoryDelivery/list`, params),
  ...
  get_add: (params: IParams) => request.post(`/V1/InventoryDelivery/add`, params),
  // 出库信息删除接口：V1/InventoryDelivery/del
  get_del: (params: IParams) => request.post(`/V1/InventoryDelivery/del`, params),
  // 生成单号
  ...
  get_export: (params: IParams) => request.post(`/V1/InventoryDelivery/export`, params),
  ...
  /**确认出库 */
  sure_delivery: (params: IParams) => request.post(`/V1/InventoryDelivery/is_delivery`, params)
}
